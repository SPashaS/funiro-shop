...
(() => {
      ...
      return (
        ...
        (e.prototype.init = function () {
          ...
          this.addSlideVideoInfo(this.galleryItems),
            this.buildStructure(),
            this.LGel.trigger(_e, { instance: this }),
        ...
        (e.prototype.triggerSlideItemLoad = function (e, t, s, i, n) {
          ...
          setTimeout(function () {
            e.addClass("lg-complete lg-complete_"),
              r.LGel.trigger(Fe, { index: t, delay: s || 0, isFirstSlide: n });
          }, a);
        }),
        ...
        (e.prototype.addSlideVideoInfo = function (e) {
          ...
          e.forEach(function (e, s) {
            (e.__slideVideoInfo = Ae(e.src, !!e.video, s)),
              e.__slideVideoInfo &&
  ...
  new st("max").init(),
    (window.onload = function () {
      ...
      const s = document.querySelector(".furniture__body");
      if (s && !t.any() && window.innerWidth > 768) {
          ...
          function (e) {
            ...
            (r = (i / t) * 200),
              s.classList.contains("_init") ||
                (requestAnimationFrame(o), s.classList.add("_init"));
          },
          { passive: !0 }
        );
      }
